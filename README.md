...
### **Big Data / Cloud**
`Apache Spark` · `PySpark` · `Hadoop` · `Hive` · `AWS EMR` · `Amazon S3`
...
`ETL Pipelines` · `Distributed Computing` · `Data Modeling` · `Schema Design`
...
### 🔹 **Spark–Hive JSON Data Processing Pipeline**
...
<p align="center">
  <img src="https://github-readme-stats.vercel.app/api?username=cd-mdzeeshan&show_icons=true&theme=tokyonight&count_private=true" />
</p>
